...
<tileset version="1.5" tiledversion="1.7.2" name="Desert" tilewidth="32" tileheight="32" spacing="1" margin="1" tilecount="48" columns="8">
 ...
 <tile id="24">
  <objectgroup draworder="index" id="2">
   <object id="3" type="WallCollider" x="13" y="13" width="19" height="19"/>
  </objectgroup>
 </tile>
 <tile id="25">
  <objectgroup draworder="index" id="2">
   <object id="1" type="WallCollider" x="0" y="12.913" width="32" height="19.087"/>
  </objectgroup>
 </tile>
 <tile id="26">
  <objectgroup draworder="index" id="2">
   <object id="1" type="WallCollider" x="0" y="0" width="32" height="32"/>
  </objectgroup>
 </tile>
